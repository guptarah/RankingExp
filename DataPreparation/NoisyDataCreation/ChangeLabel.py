...
def AddNoise(labels_file,k=0):
   ...
   noise1 = (2*k)*numpy.random.uniform(-1,1,size_labels) 
   noise2 = (2.5*k)*numpy.random.uniform(-1,1,size_labels) 
   noise3 = (3*k)*numpy.random.uniform(-1,1,size_labels) 
   noise4 = (3.5*k)*numpy.random.uniform(-1,1,size_labels) 
   noise5 = (4*k)*numpy.random.uniform(-1,1,size_labels) 
   noise6 = (4.5*k)*numpy.random.uniform(-1,1,size_labels) 
...
if __name__ == "__main__":
   if len(sys.argv) != 3:
      print 'please give the labels file and noise level\
             Usage: python ChangeLabel.py LablesFile noise_level' 
   else:
