...
if __name__ == "__main__":
   if len(sys.argv) != 7:
      ...
      Usage: python PerformCV.py qid_file diff_feat_dir feat_file labels_file count_noisy_labels_file batch_size"
   else:
      qid_file = sys.argv[1]
      ...
      labels_file = sys.argv[4] # directory containing labels file as well
